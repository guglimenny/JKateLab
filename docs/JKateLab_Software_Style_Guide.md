...
6. [Implementation guidelines](#6-implementation-guidelines)
   ...
   - [6.12 Deprecation and backward compatibility](#612-deprecation-and-backward-compatibility)
   - [6.13 Future-proofing](#613-future-proofing)
7. [Testing guidelines](#7-testing-guidelines)
    - [7.1 General philosophy](#71-general-philosophy)
    - [7.2 Test organisation](#72-test-organisation)
    - [7.3 Test implementation and automation](#73-test-implementation-and-automation)
    - [7.4 Performance testing](#74-performance-testing)
    - [7.5 Scientific testing](#75-scientific-testing)
    - [7.6 Regression testing](#76-regression-testing)
    - [7.7 Numerical testing](#77-numerical-testing)
    - [7.8 Test coverage](#78-test-coverage)
    - [7.9 Testing notebooks](#79-testing-notebooks)
8. [Version control and development workflow](#8-version-control-and-development-workflow)
    - [8.1 General philosophy](#81-general-philosophy)
    - [8.2 Branches](#82-branches)
    - [8.3 Commits](#83-commits)
    - [8.4 Commit messages](#84-commit-messages)
    - [8.5 Development workflow](#85-development-workflow)
    - [8.6 Development history](#86-development-history)
9. [Project management](#9-project-management)
    - [9.1 Planning and priorities](#91-planning-and-priorities)
    - [9.2 TODOs and future work](#92-todos-and-future-work)
    - [9.3 Project decisions](#93-project-decisions)
    - [9.4 General principles](#94-general-principles)
